...
We say that $F$ is an \emph{equivalence} of categories if $F$ is fully faithful, and \oldpage{148}if any object $S'$ of $\C'$ is isomorphic to an object of the form $F (S)$.
