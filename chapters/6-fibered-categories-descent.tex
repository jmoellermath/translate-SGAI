...
Moreover, starting from a fibre bundle $E$ on $X$, one says that $X$ is ``locally trivial'', of fibre $F$, if there exists an open covering $(X_i)$ of $X$ such that the $E| X_i$ are isomorphic to $F \times X_i$, or, equivalently, such that the inverse image $E'$ of $E$ over $X' = \coprod_i X_i$ is isomorphic to $X'\times F$.
